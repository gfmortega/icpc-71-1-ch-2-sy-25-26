...
\begin{center}
    \includegraphics[width=0.65\linewidth]{img/rainbow-b.png}
\end{center}
...
Alice and Cindy got a bit excited and immediately started drawing wires in Zones A and C.  Alice drew $n$ wires, but made it so that there is no node connected to two wires; so did Cindy.  For example, with $n=4$, they might have done the following.
\begin{center}
    \includegraphics[width=0.65\linewidth]{img/rainbow-1-b.png}
\end{center}
...
\begin{center}
    \includegraphics[width=0.65\linewidth]{img/rainbow-2-b.png}
\end{center}
